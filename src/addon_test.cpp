...
unsigned int PostProcess(const ADDON_HANDLE handle, unsigned int mode_id, float **array_in, float **array_out, unsigned int samples)
{
  return ((cDSPProcessorStream*)handle->callerAddress)->PostProcess(mode_id, array_in, array_out, samples);
    ...
    ////////////////////////////////////////////////
/*
unsigned int PostProcessStereoToMS(const ADDON_HANDLE handle, unsigned int mode_id, float **array_in, float **array_out, unsigned int samples)
{
    return ((cDSPProcessorStream*)handle->callerAddress)->PostProcessStereoToMS(mode_id, array_in, array_out, samples);
}
*/
    ////////////////////////////////////////////////
    ////////////////////////////////////////////////
