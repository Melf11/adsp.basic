...
public:
   ...
   // unsigned int  PostProcessStereoToMS(float **array_in, float **array_out, unsigned int samples);
...
public:
    ...
    void DestroyDSP();
     ...
     bool EnablePostProcessStereoToMS(unsigned int modeId, bool enable);
